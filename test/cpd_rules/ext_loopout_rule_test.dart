...
void main() {
  group('CPD Rule Tests - Extension-Loopout', () {
    ...
    setUpAll(() async {
      String extLoopoutTestCasesScContent = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_loopout_design.sc',
      );
      String identifiedTBasesJsonLog = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_loopout_identified_t_bases.json',
      );
      String cpdSitesJsonLog = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_loopout_expected_cpd_sites.json',
      );
      String tBaseLocationsJsonLog = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_loopout_expected_t_base_locations.json',
      );
