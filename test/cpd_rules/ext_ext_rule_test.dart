...
void main() {
  group('CPD Rule Tests - Extension-Extension', () {
    ...
    setUpAll(() async {
      String extExtTestCasesScContent = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_ext_design.sc',
      );
      String identifiedTBasesJsonLog = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_ext_identified_t_bases.json',
      );
      String cpdSitesJsonLog = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_ext_expected_cpd_sites.json',
      );
      String tBaseLocationsJsonLog = await util.get_text_file_content(
        '../tests_inputs/cpd_detection/ext_ext_expected_t_base_locations.json',
      );
